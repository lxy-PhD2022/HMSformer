...
parser.add_argument('--distil', action='store_false',
                    ...
                    default=True)
parser.add_argument('--dropout', type=float, default=0.1272054200838379, help='dropout')
...
parser.add_argument('--period', type=int, default=24, help='accumulation_steps')
...
if args.is_training:
    for ii in range(args.itr):
        args.d_model = int(args.x * args.n_heads)
